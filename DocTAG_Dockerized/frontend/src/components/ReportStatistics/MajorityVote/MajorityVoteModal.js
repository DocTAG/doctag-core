...
function MajorityVoteModal(props) {
    ...
    function createGT(e){
        e.preventDefault()
        axios.post('create_majority_vote_groundtruth',{action:selectedAct,topic:props.topic, mode:selectedMode,users:ChosenUsers,id_report:props.id_report,language:props.language})
            .then(response=>{
